...
public final class Db {
    ...
    static {
        ...
        if (Constants.isTestnet) {
            ...
            dbUsername = Nxt.getStringProperty("brs.testDbUsername");
            dbPassword = Nxt.getStringProperty("brs.testDbPassword");
        } else {
            dbUrl = Nxt.getStringProperty("brs.dbUrl");
            dbUsername = Nxt.getStringProperty("brs.dbUsername");
            dbPassword = Nxt.getStringProperty("brs.dbPassword");
        }
        ...
        try {
            ...
            config.setMaximumPoolSize(Nxt.getIntProperty("brs.dbMaximumPoolSize"));
            ...
            if (DATABASE_TYPE == TYPE.H2) {
                int defaultLockTimeout = Nxt.getIntProperty("brs.dbDefaultLockTimeout") * 1000;
