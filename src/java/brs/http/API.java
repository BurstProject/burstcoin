...
public final class API {
    ...
    static final boolean enableDebugAPI = Nxt.getBooleanProperty("brs.enableDebugAPI");
    private static final Logger logger = LoggerFactory.getLogger(API.class);
    private static final int TESTNET_API_PORT = 6876;
    private static final Server apiServer;

    static {
        List<String> allowedBotHostsList = Nxt.getStringListProperty("brs.allowedBotHosts");
        ...
        boolean enableAPIServer = Nxt.getBooleanProperty("brs.enableAPIServer");
        if (enableAPIServer) {
            final int port = Constants.isTestnet ? TESTNET_API_PORT : Nxt.getIntProperty("brs.apiServerPort");
            final String host = Nxt.getStringProperty("brs.apiServerHost");
            apiServer = new Server();
            ServerConnector connector;

            boolean enableSSL = Nxt.getBooleanProperty("brs.apiSSL");
            if (enableSSL) {
                ...
                sslContextFactory.setKeyStorePath(Nxt.getStringProperty("brs.keyStorePath"));
                sslContextFactory.setKeyStorePassword(Nxt.getStringProperty("brs.keyStorePassword"));
            ...
            connector.setIdleTimeout(Nxt.getIntProperty("brs.apiServerIdleTimeout"));
            ...
            String apiResourceBase = Nxt.getStringProperty("brs.apiResourceBase");
            ...
            String javadocResourceBase = Nxt.getStringProperty("brs.javadocResourceBase");
            ...
            if (Nxt.getBooleanProperty("brs.enableAPIServerGZIPFilter")) {
            ...
            if (Nxt.getBooleanProperty("brs.apiServerCORS")) {
