...
public class AccountAssetRecord extends UpdatableRecordImpl<AccountAssetRecord> implements Record7<Long, Long, Long, Long, Long, Integer, Byte> {
     ...
     */
    @Override
    public Row7<Long, Long, Long, Long, Long, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Long, Long, Long, Long, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public AccountAssetRecord value7(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public AccountAssetRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountAssetRecord(Long dbId, Long accountId, Long assetId, Long quantity, Long unconfirmedQuantity, Integer height, Byte latest) {
        super(AccountAsset.ACCOUNT_ASSET);
