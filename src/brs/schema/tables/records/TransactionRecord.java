...
public class TransactionRecord extends UpdatableRecordImpl<TransactionRecord> {
    ...
    private static final long serialVersionUID = 601712601;
     ...
     */
    public void setHasEncrypttoselfMessage(Byte value) {
        set(24, value);
    }
     ...
     */
    public TransactionRecord(Long dbId, Long id, Short deadline, byte[] senderPublicKey, Long recipientId, Long amount, Long fee, Integer height, Long blockId, byte[] signature, Integer timestamp, Byte type, Byte subtype, Long senderId, Integer blockTimestamp, byte[] fullHash, byte[] referencedTransactionFullHash, byte[] attachmentBytes, Byte version, Byte hasMessage, Byte hasEncryptedMessage, Byte hasPublicKeyAnnouncement, Integer ecBlockHeight, Long ecBlockId, Byte hasEncrypttoselfMessage) {
        super(Transaction.TRANSACTION);
