...
public class BidOrderRecord extends UpdatableRecordImpl<BidOrderRecord> implements Record9<Long, Long, Long, Long, Long, Long, Integer, Integer, Byte> {

    private static final long serialVersionUID = 1757921994;
     ...
     */
    @Override
    public Row9<Long, Long, Long, Long, Long, Long, Integer, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, Long, Long, Long, Long, Integer, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public BidOrderRecord value9(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public BidOrderRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Long value6, Integer value7, Integer value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BidOrderRecord(Long dbId, Long id, Long accountId, Long assetId, Long price, Long quantity, Integer creationHeight, Integer height, Byte latest) {
        super(BidOrder.BID_ORDER);
