...
public class EscrowRecord extends UpdatableRecordImpl<EscrowRecord> implements Record10<Long, Long, Long, Long, Long, Integer, Integer, Integer, Integer, Byte> {
     ...
     */
    @Override
    public Row10<Long, Long, Long, Long, Long, Integer, Integer, Integer, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, Long, Long, Long, Long, Integer, Integer, Integer, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public EscrowRecord value10(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public EscrowRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6, Integer value7, Integer value8, Integer value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EscrowRecord(Long dbId, Long id, Long senderId, Long recipientId, Long amount, Integer requiredSigners, Integer deadline, Integer deadlineAction, Integer height, Byte latest) {
        super(Escrow.ESCROW);
