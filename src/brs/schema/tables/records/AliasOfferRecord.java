...
public class AliasOfferRecord extends UpdatableRecordImpl<AliasOfferRecord> implements Record6<Long, Long, Long, Long, Integer, Byte> {

    private static final long serialVersionUID = 566016605;
     ...
     */
    @Override
    public Row6<Long, Long, Long, Long, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, Long, Long, Long, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public AliasOfferRecord value6(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public AliasOfferRecord values(Long value1, Long value2, Long value3, Long value4, Integer value5, Byte value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AliasOfferRecord(Long dbId, Long id, Long price, Long buyerId, Integer height, Byte latest) {
        super(AliasOffer.ALIAS_OFFER);
