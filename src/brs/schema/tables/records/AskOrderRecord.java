...
public class AskOrderRecord extends UpdatableRecordImpl<AskOrderRecord> implements Record9<Long, Long, Long, Long, Long, Long, Integer, Integer, Byte> {

    private static final long serialVersionUID = -1704080450;
     ...
     */
    @Override
    public AskOrderRecord value9(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public AskOrderRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Long value6, Integer value7, Integer value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AskOrderRecord(Long dbId, Long id, Long accountId, Long assetId, Long price, Long quantity, Integer creationHeight, Integer height, Byte latest) {
        super(AskOrder.ASK_ORDER);
