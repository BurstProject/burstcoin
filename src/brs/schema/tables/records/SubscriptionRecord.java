...
public class SubscriptionRecord extends UpdatableRecordImpl<SubscriptionRecord> implements Record9<Long, Long, Long, Long, Long, Integer, Integer, Integer, Byte> {
     ...
     */
    @Override
    public Row9<Long, Long, Long, Long, Long, Integer, Integer, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, Long, Long, Long, Integer, Integer, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public SubscriptionRecord value9(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public SubscriptionRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6, Integer value7, Integer value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SubscriptionRecord(Long dbId, Long id, Long senderId, Long recipientId, Long amount, Integer frequency, Integer timeNext, Integer height, Byte latest) {
        super(Subscription.SUBSCRIPTION);
