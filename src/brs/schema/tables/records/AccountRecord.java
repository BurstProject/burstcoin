...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record12<Long, Long, Integer, byte[], Integer, Long, Long, Long, String, String, Integer, Byte> {

    private static final long serialVersionUID = 217067672;
     ...
     */
    @Override
    public Row12<Long, Long, Integer, byte[], Integer, Long, Long, Long, String, String, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row12<Long, Long, Integer, byte[], Integer, Long, Long, Long, String, String, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public AccountRecord value12(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public AccountRecord values(Long value1, Long value2, Integer value3, byte[] value4, Integer value5, Long value6, Long value7, Long value8, String value9, String value10, Integer value11, Byte value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Long dbId, Long id, Integer creationHeight, byte[] publicKey, Integer keyHeight, Long balance, Long unconfirmedBalance, Long forgedBalance, String name, String description, Integer height, Byte latest) {
        super(Account.ACCOUNT);
