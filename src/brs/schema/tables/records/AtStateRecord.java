...
public class AtStateRecord extends UpdatableRecordImpl<AtStateRecord> implements Record11<Long, Long, byte[], Integer, Integer, Integer, Long, Boolean, Long, Integer, Byte> {
     ...
     */
    @Override
    public Row11<Long, Long, byte[], Integer, Integer, Integer, Long, Boolean, Long, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, Long, byte[], Integer, Integer, Integer, Long, Boolean, Long, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public AtStateRecord values(Long value1, Long value2, byte[] value3, Integer value4, Integer value5, Integer value6, Long value7, Boolean value8, Long value9, Integer value10, Byte value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
