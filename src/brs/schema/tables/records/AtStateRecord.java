...
public class AtStateRecord extends UpdatableRecordImpl<AtStateRecord> implements Record11<Long, Long, byte[], Integer, Integer, Integer, Long, Byte, Long, Integer, Byte> {
     ...
     */
    public void setFreezeWhenSameBalance(Byte value) {
        set(7, value);
    }
     ...
     */
    public Byte getFreezeWhenSameBalance() {
        return (Byte) get(7);
    }
     ...
     */
    @Override
    public Row11<Long, Long, byte[], Integer, Integer, Integer, Long, Byte, Long, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, Long, byte[], Integer, Integer, Integer, Long, Byte, Long, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public AtStateRecord value8(Byte value) {
     ...
     */
    @Override
    public AtStateRecord value11(Byte value) {
        setLatest(value);
        return this;
    }
     ...
     */
    @Override
    public AtStateRecord values(Long value1, Long value2, byte[] value3, Integer value4, Integer value5, Integer value6, Long value7, Byte value8, Long value9, Integer value10, Byte value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AtStateRecord(Long dbId, Long atId, byte[] state, Integer prevHeight, Integer nextHeight, Integer sleepBetween, Long prevBalance, Byte freezeWhenSameBalance, Long minActivateAmount, Integer height, Byte latest) {
        super(AtState.AT_STATE);
