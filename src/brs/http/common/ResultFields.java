...
public class ResultFields {
  ...
  public static final String DECRYPTED_MESSAGE_RESULT = "decryptedMessage";
  public static final String BALANCE_NQT = "balanceNQT";
  public static final String UNCONFIRMED_BALANCE_NQT = "unconfirmedBalanceNQT";
  public static final String EFFECTIVE_BALANCE_NQT = "effectiveBalanceNXT";
  public static final String FORGED_BALANCE_NQT = "forgedBalanceNQT";
  public static final String GUARANTEED_BALANCE_NQT = "guaranteedBalanceNQT";
