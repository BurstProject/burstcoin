...
public final class JSONResponses {
  ...
  public static final JSONStreamAware INCORRECT_TRANSACTION_BYTES_OR_JSON = incorrect(TRANSACTION_BYTES_PARAMETER + " or " + TRANSACTION_JSON_PARAMETER);
  ...
  public static final JSONStreamAware MISSING_TIMESTAMP = missing(TIMESTAMP_PARAMETER);
  ...
  public static final JSONStreamAware MISSING_BLOCK = missing(BLOCK_PARAMETER);
  ...
  public static final JSONStreamAware MISSING_NUMBER_OF_CONFIRMATIONS = missing(NUMBER_OF_CONFIRMATIONS_PARAMETER);
  ...
  public static final JSONStreamAware MISSING_MESSAGE = missing(MESSAGE_PARAMETER);
  ...
  public static final JSONStreamAware MISSING_DESCRIPTION = missing(DESCRIPTION_PARAMETER);
  ...
  public static final JSONStreamAware INCORRECT_POLL_NAME_LENGTH = incorrect(NAME_PARAMETER, "(length must be not longer than " + Constants.MAX_POLL_NAME_LENGTH + " characters)");
  public static final JSONStreamAware INCORRECT_POLL_DESCRIPTION_LENGTH = incorrect(DESCRIPTION_PARAMETER, "(length must be not longer than " + Constants.MAX_POLL_DESCRIPTION_LENGTH + " characters)");
  ...
  public static final JSONStreamAware INCORRECT_UNSIGNED_BYTES = incorrect(UNSIGNED_TRANSACTION_BYTES_PARAMETER);
  ...
  public static final JSONStreamAware INCORRECT_DELTA_QUANTITY = incorrect(DELTA_QUALITY_PARAMETER);
  public static final JSONStreamAware MISSING_DELTA_QUANTITY = missing(DELTA_QUALITY_PARAMETER);
  ...
  public static final JSONStreamAware INCORRECT_AUTOMATED_TRANSACTION_DESCRIPTION_LENGTH = incorrect(DESCRIPTION_PARAMETER, "(length must not exceed " + Constants.MAX_AUTOMATED_TRANSACTION_DESCRIPTION_LENGTH + " characters)");
