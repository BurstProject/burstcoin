...
public final class APIServlet extends HttpServlet {
  ...
  public static void injectServices(TransactionProcessor transactionProcessor, Blockchain blockchain, BlockchainProcessor blockchainProcessor, ParameterService parameterService,
    ...
    map.put("cancelAskOrder", new CancelAskOrder(parameterService, transactionProcessor, blockchain));
    map.put("cancelBidOrder", new CancelBidOrder(parameterService, transactionProcessor, blockchain));
    ...
    map.put("dgsListing", new DGSListing(parameterService, transactionProcessor, blockchain));
    map.put("dgsDelisting", new DGSDelisting(parameterService, transactionProcessor, blockchain));
    map.put("dgsDelivery", new DGSDelivery(parameterService, transactionProcessor, blockchain));
    map.put("dgsFeedback", new DGSFeedback(parameterService, transactionProcessor, blockchain));
    map.put("dgsPriceChange", new DGSPriceChange(parameterService, transactionProcessor, blockchain));
    map.put("dgsPurchase", new DGSPurchase(parameterService, transactionProcessor, blockchain));
    map.put("dgsQuantityChange", new DGSQuantityChange(parameterService, transactionProcessor, blockchain));
    map.put("dgsRefund", new DGSRefund(parameterService, transactionProcessor, blockchain));
    ...
    map.put("sellAlias", new SellAlias(parameterService, transactionProcessor, blockchain));
    map.put("buyAlias", new BuyAlias(parameterService, transactionProcessor, blockchain, aliasService));
    ...
    map.put("issueAsset", new IssueAsset(parameterService, transactionProcessor, blockchain));
    map.put("leaseBalance", new LeaseBalance(parameterService, transactionProcessor, blockchain));
    ...
    map.put("placeAskOrder", new PlaceAskOrder(parameterService, transactionProcessor, blockchain));
    map.put("placeBidOrder", new PlaceBidOrder(parameterService, transactionProcessor, blockchain));
    map.put("rsConvert", RSConvert.instance);
    map.put("readMessage", new ReadMessage(blockchain));
    map.put("sendMessage", new SendMessage(parameterService, transactionProcessor, blockchain));
    map.put("sendMoney", new SendMoney(parameterService, transactionProcessor, blockchain));
    map.put("setAccountInfo", new SetAccountInfo(parameterService, transactionProcessor, blockchain));
    map.put("setAlias", new SetAlias(parameterService, transactionProcessor, blockchain));
    ...
    map.put("transferAsset", new TransferAsset(parameterService, transactionProcessor, blockchain));
    ...
    map.put("setRewardRecipient", new SetRewardRecipient(parameterService, transactionProcessor, blockchain));
    map.put("getAccountsWithRewardRecipient", new GetAccountsWithRewardRecipient(parameterService, accountService));
    map.put("sendMoneyEscrow", new SendMoneyEscrow(parameterService, transactionProcessor, blockchain));
    map.put("escrowSign", new EscrowSign(parameterService, transactionProcessor, blockchain));
    ...
    map.put("sendMoneySubscription", new SendMoneySubscription(parameterService, transactionProcessor, blockchain));
    map.put("subscriptionCancel", new SubscriptionCancel(parameterService, transactionProcessor, blockchain));
    ...
    map.put("createATProgram", new CreateATProgram(parameterService, transactionProcessor, blockchain));
